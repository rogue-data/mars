...
$(function()
{
    var playerTrack = $("#player-track"), bgArtwork = $('#bg-artwork'), bgArtworkUrl, albumName = $('#album-name'), trackName = $('#track-name'), albumArt = $('#album-art'), sArea = $('#s-area'), seekBar = $('#seek-bar'), trackTime = $('#track-time'), insTime = $('#ins-time'), sHover = $('#s-hover'), playPauseButton = $("#play-pause-button"),  i = playPauseButton.find('i'), tProgress = $('#current-time'), tTime = $('#track-length'), seekT, seekLoc, seekBarPos, cM, ctMinutes, ctSeconds, curMinutes, curSeconds, durMinutes, durSeconds, playProgress, bTime, nTime = 0, buffInterval = null, tFlag = false, albums = ['album_name'], trackNames = ['Song_name'], albumArtworks = ['_1'], trackUrl = ['./Working Directory/songs/0.mp3'], playPreviousTrackButton = $('#play-previous'), playNextTrackButton = $('#play-next'), currIndex = -1;
...
function change_bg(){
    ...
    sw.forEach(x => {if(x.checked){
        ...
        if(x.value=='1'){
            ...
            bd_img.style.background="url('./images/work3.jpg') no-repeat";
            bd_img.style.backgroundSize="100%";
            var font_mode=document.querySelectorAll('h3');
            var mode_col=document.querySelector("#modes");
            mode_col.style.color="rgb(0,0,0)";
